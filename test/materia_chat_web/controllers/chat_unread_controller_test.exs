...
#
  ...
  #    conn = post conn, chat_unread_path(conn, :create), @create_attrs
...
#
  ...
  #    conn = post conn, chat_unread_path(conn, :create), @invalid_attrs
...
#
  ...
  #    conn = put conn, chat_unread_path(conn, :update, chat_unread), @update_attrs
...
#
  ...
  #    conn = put conn, chat_unread_path(conn, :update, chat_unread), @invalid_attrs
  #    assert json_response(conn, 422)["errors"] != %{}
  #  end
  #end
#
